...
const VideoCard = ({info}) => {
  ...
  return (
    <div className='p-2 m-2 w-auto mb-8 md:mb-0 md:w-[30rem] md:h-96 rounded-lg shadow-gray-400  transition duration-300 ease-in-out hover:scale-95 hover:cursor-pointer h-80 flex flex-col items-center'>
      <div className=' '>
